...
vim.keymap.set('n', 'ld', vim.diagnostic.open_float, { desc = "Open floating diagnostic message" })
vim.keymap.set('n', 'lq', vim.diagnostic.setloclist, { desc = "Open diagnostics list" })
